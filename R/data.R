...
#'
#' This package contains data for the canvasXpress R package
#'
#' @docType package
...
#' Gene Expression Dataset - Cervical Cancer
#' 
...
#' @source \url{https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GPL96}
#' 
#' @references [HG-U133A] Affymetrix Human Genome U133A Array
#' 
